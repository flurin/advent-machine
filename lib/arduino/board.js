...
module.exports = function(config){
  ...
  var patternLeds = function(patterns, frameTime, intervalTime){
    ...
    console.log("Pattern!", patterns.length, patterns)

    var intrapolatedPattern = patterns.map(function(pattern){
      console.log(pattern.length, led.length);
    ...
    console.log("iPattern", intrapolatedPattern.length);
  ...
  var setLeds = function(colors){
    ...
    colors.forEach(function(color, i){
      console.log("setting color", color.rgbArray(), i);
