...
var chaserPattern = function(color, rounds, fade, invert){
  ...
  for(var r = 0; r < rounds; r++){
    for(var l = 0; l < ledCount; l++){
      ...
      console.log(r, l, darken, color.clone().darken(darken).rgbArray());
  ...
  if(invert){
    frames = frames.slice().reverse().concat(frames);
  }
...
module.exports = {
  fadeInOutChaserBlue : function(options){
    if(!options){ options = {}; }
    var pattern = chaserPattern(blue, 3, 1, true)
